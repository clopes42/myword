...
function ae_scripts()
{
    ...
    wp_enqueue_script('ae-angular-router', '//ajax.googleapis.com/ajax/libs/angularjs/1.3.14/angular-route.js', array('ae-angular'), '', true);
    wp_enqueue_script('ae-angular-sanitize', '//ajax.googleapis.com/ajax/libs/angularjs/1.3.14/angular-sanitize.js', array('ae-angular'), '', true);
